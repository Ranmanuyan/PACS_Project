/*
 * Bob++ MIP solver with the generic Glock cuts
 */
...
public:
  ...
  typedef Bob::CutGenerator3 < TstMipTrait,
  Bob::MixedIntegerRoundingCutGenerator<TstMipTrait, Bob::CC_All>,
  Bob::FlowCoverCutGenerator<TstMipTrait, Bob::CC_All>,
  Bob::KnapsackCoverCutGenerator<TstMipTrait, Bob::CC_All>,
  Bob::CC_RootOnly_IteFixed > CutGenerator;
  typedef Bob::LPvarcut<TstMipTrait> LP;
